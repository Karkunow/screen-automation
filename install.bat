...
powershell -NoProfile -Command "$cur = [Environment]::GetEnvironmentVariable('PATH','Machine'); if ($cur -notlike '*Tesseract-OCR*') { [Environment]::SetEnvironmentVariable('PATH', $cur + ';%TESS_BIN%', 'Machine') }" >nul 2>&1
